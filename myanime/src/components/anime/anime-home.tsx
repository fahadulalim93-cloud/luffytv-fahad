    ...
    <section className="space-y-3 scroll-section">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => scroll("left")} className="scroll-btn p-2 text-zinc-500 hover:text-white bg-[#0f0f1a]/80 hover:bg-red-500/20 rounded-full transition-all backdrop-blur-sm border border-white/[0.06]">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M15 19l-7-7 7-7" /></svg>
          </button>
          <button onClick={() => scroll("right")} className="scroll-btn p-2 text-zinc-500 hover:text-white bg-[#0f0f1a]/80 hover:bg-red-500/20 rounded-full transition-all backdrop-blur-sm border border-white/[0.06]">
    ...
    <div className="space-y-8 fade-in">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-violet-600 flex items-center justify-center shadow-lg shadow-red-500/25">
            ...
            {(["sub", "dub", "hindi"] as const).map(lang => (
              <button
                ...
                className={`px-4 py-1.5 text-[11px] font-bold rounded-full transition-all ${
                  activeLang === lang
                    ? lang === "sub" ? "bg-red-500/15 text-purple-300" : lang === "dub" ? "bg-red-500/15 text-violet-300" : "bg-orange-500/15 text-orange-300"
        ...
        <div className="scroll-container flex gap-1.5 overflow-x-auto pb-1">
          <button
            ...
            className={`shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-full transition-all border ${
              !activeGenre
                ? "bg-red-500/15 border-red-500/20 text-purple-300"
      ...
      {loading ? (
        ...
        <>
          ...
          {popular.length > 0 && (
            <ContentSection
              title="Popular Anime"
              icon={<svg className="w-5 h-5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" /></svg>}
            >
            ...
            <div className="text-center py-20 bg-[#0a0a14] rounded-2xl border border-white/[0.04]">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold bg-red-500/15 text-purple-300 rounded-full hover:bg-red-500/25 transition-all border border-red-500/20"
                >
                  Refresh Page
                </button>
              </div>
